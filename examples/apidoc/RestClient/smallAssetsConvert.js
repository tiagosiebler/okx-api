const { RestClient } = require('okx-api');
  ...
  // ENDPOINT: /api/v5/asset/convert-dust-assets
  // METHOD: POST
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/okx-api/blob/master/src/rest-client.ts#L2446
...
client.smallAssetsConvert(params)
  .then((response) => {
